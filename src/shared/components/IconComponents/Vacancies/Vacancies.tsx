    ...
    case 'magnifying-glass':
      return (
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <path d="M10 18.5518C11.775 18.5514 13.4988 17.9572 14.897 16.8638L19.293 21.2598L20.707 19.8458L16.311 15.4498C17.405 14.0514 17.9996 12.3272 18 10.5518C18 6.14076 14.411 2.55176 10 2.55176C5.589 2.55176 2 6.14076 2 10.5518C2 14.9628 5.589 18.5518 10 18.5518ZM10 4.55176C13.309 4.55176 16 7.24276 16 10.5518C16 13.8608 13.309 16.5518 10 16.5518C6.691 16.5518 4 13.8608 4 10.5518C4 7.24276 6.691 4.55176 10 4.55176Z" />
        </svg>
      );
